...
class DefaultArtifactComparatorTest {
    ...
    void sortedSet() {
        ...
        Assertions.assertEquals("0z", artifacts.get(0).groupId());
        Assertions.assertEquals("1.0", artifacts.get(1).version());
        Assertions.assertEquals("1.1", artifacts.get(2).version());
        Assertions.assertEquals("1.3", artifacts.get(3).version());
        Assertions.assertEquals("2.0", artifacts.get(4).version());
    }
}
